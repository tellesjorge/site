      ...
      <div className="flex flex-col gap-6 rounded-[28px] border border-black/5 bg-slate-50 p-8 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-semibold text-[#1d1d1f] sm:text-4xl">
            {t({ pt: 'Download do Currículo em PDF', en: 'Download PDF Resume' })}
          </h2>
          <p className="mt-4 max-w-xl text-sm leading-6 text-[#6e6e73]">
            {t({
              pt: 'Baixe o perfil profissional completo com histórico de carreira, competências e resultados para fins de recrutamento.',
              en: 'Download the full professional profile with career history, qualifications, and performance highlights.'
            })}
          </p>
        </div>
        <a
        ...
        >
          <Download className="h-4 w-4" /> {t({ pt: 'Baixar Currículo em PDF', en: 'Download PDF Resume' })}
        </a>
      </div>
    </motion.section>
  )
